...
public class Table {
	...
	public PDFont getColumnTextFont() {
		return columnTextFont;
	}


	public void setColumnTextFont(PDFont columnTextFont) {
		this.columnTextFont = columnTextFont;
	}
