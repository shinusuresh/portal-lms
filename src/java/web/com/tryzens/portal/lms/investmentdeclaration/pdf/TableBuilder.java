...
public class TableBuilder {
	...
	public TableBuilder setTableIndex(Integer index) {
	...
	public TableBuilder setColumnFontSize(float fontSize) {
		table.setColumnFontSize(fontSize);
		return this;
	}
	
	public TableBuilder setColumnFont(PDFont textFont) {
		table.setColumnTextFont(textFont);
		return this;
	}
