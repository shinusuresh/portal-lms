...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Weekend Working</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<div class="row">
	       	...
	       	$( "#searchForm" ).submit(function( event ) {       	 
	       	  ...
	       	  //initiate an ajax call for skills search. Return data will populate in datatable
	       	    if($('#month').val() != 'month'&&$('#year').val() != 'year'){
	       	    	sendAjax("/portal-lms/requests/getweekendworkingrequestsforuser.ajax?month="+$('#month').val()+"&year="+$('#year').val());	
	       	    } else {
